...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="UART" URI="http://resources/4.1.14/app/UART/0" description="UART APP configures a USIC channel to perform &#xA;transmit &amp; receive operations using UART protocol." mode="NOTSHARABLE" version="4.1.14" minDaveVersion="4.0.0" instanceLabel="UART_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_fifo_transmit" URI="http://resources/4.1.14/app/UART/0/vs_uart_fifo_tx_int" hwSignal="standard_transmit_buffer_int" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="event_fifo_std_receive" URI="http://resources/4.1.14/app/UART/0/vs_uart_fifo_rx_int" hwSignal="standard_receive_buffer_int" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="event_fifo_alt_receive" URI="http://resources/4.1.14/app/UART/0/vs_uart_fifo_alt_rx_int" hwSignal="alternate_receive_buffer_int" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="sr_transmit" URI="http://resources/4.1.14/app/UART/0/vs_interrupt_uart_tx" hwSignal="signal_in" hwResource="//@hwResources.3" required="false"/>
  <virtualSignals name="sr_receive" URI="http://resources/4.1.14/app/UART/0/vs_interrupt_uart_rx" hwSignal="signal_in" hwResource="//@hwResources.4" required="false"/>
  ...
  <requiredApps URI="http://resources/4.1.14/app/UART/0/appres_cpu" requiredAppName="CPU_CTRL_XMC4" required="false" requiringMode="SHARABLE"/>
  ...
  <hwResources name="NVIC Node Tx" URI="http://resources/4.1.14/app/UART/0/hwres_nvic_node_tx" resourceGroupUri="" required="false" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*"/>
  <hwResources name="NVIC Node Rx" URI="http://resources/4.1.14/app/UART/0/hwres_nvic_node_rx" resourceGroupUri="" required="false" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*"/>
  ...
  <hwResources name="Receive Pin" URI="http://resources/4.1.14/app/UART/0/__pin_hwres_port_pad_uart_rx" resourceGroupUri="devicepackage/0/2" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.2"/>
  </hwResources>
  <hwResources name="Transmit Pin" URI="http://resources/4.1.14/app/UART/0/__pin_hwres_port_pad_uart_tx" resourceGroupUri="devicepackage/0/1" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_dma_interrupt_tx/http://resources/4.1.14/app/UART/0/vsra_gpdma_interrupt" systemDefined="true" sourceSignal="DMA Transfer complete event" targetSignal="Interrupt signal" required="false" srcVirtualSignal="//@virtualSignals.19" containingProxySignal="true"/>
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_dma_interrupt_rx/http://resources/4.1.14/app/UART/0/vsra_gpdma_interrupt" systemDefined="true" sourceSignal="DMA Transfer complete event" targetSignal="Interrupt signal" required="false" srcVirtualSignal="//@virtualSignals.20" proxyTargetVirtualSignalUri="http://resources/4.0.10/app/GLOBAL_DMA/0/interrupt_dma" containingProxySignal="true"/>
